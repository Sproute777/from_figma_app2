...
class SignUpDefaultPage extends StatefulWidget {
  const SignUpDefaultPage({Key? key})
      : super(
          key: key,
        );

  @override
  SignUpDefaultPageState createState() => SignUpDefaultPageState();
}

class SignUpDefaultPageState extends State<SignUpDefaultPage>
    with AutomaticKeepAliveClientMixin<SignUpDefaultPage> {
