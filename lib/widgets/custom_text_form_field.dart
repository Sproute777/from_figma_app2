...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get outlinePrimaryContainerTL121 =>
      OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            12.00,
  ...
  static OutlineInputBorder get outlineGray10001TL12 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            12.00,
          ),
  ...
  static OutlineInputBorder get outlinePrimaryContainerTL122 =>
      OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            12.00,
  ...
  static UnderlineInputBorder get underLineGray10001 => UnderlineInputBorder(
        borderSide: BorderSide(
          color: appTheme.gray10001,
        ),
      );
  ...
  static OutlineInputBorder get outlinePrimaryContainerTL123 =>
      OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            12.00,
